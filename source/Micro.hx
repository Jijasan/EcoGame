...
class Micro extends FlxSprite
{
	 ...
	 */
	public function new(X:Int, Y:Int, Bullets:FlxTypedGroup<FlxSprite>, type:Int)
	{
		var scaleRate = 0.1;
		...
		loadGraphic("assets/micro.png", true, 256, 256);
		scale.set(scaleRate, scaleRate);
		width *= scaleRate;
		height *= scaleRate;
		updateHitbox();
		_originalX = X;
		...
		this.animation.add("Default", [type * 10]);
